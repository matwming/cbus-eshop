            ...
            >
              <svg aria-hidden viewBox="0 0 24 24" className="h-4 w-4">
                <path
                  ...
                  d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm1 14H11v-2h2v2Zm0-4H11V6h2v6Z"
                />
              </svg>
              Error
            </motion.div>
          ...
          >
            ...
            >
              <svg aria-hidden className="h-4 w-4" viewBox="0 0 24 24">
                <path
                  className="fill-current"
                  d="M12 5v2a5 5 0 1 1-4.546 2.916l-1.79-.895A7 7 0 1 0 12 5Zm7-2h-6v2h3.586L14 7.586 15.414 9 20 4.414 18.586 3 16 5.586V2Z"
                />
              </svg>
              Try again
            </motion.button>

...
describe('ProductButtons', () => {
    ...
    it('clicking Add to cart adds item to cart (qty 1) and swaps to <Quantity>', () => {
        ...
        //Assert
        const button = screen.getByRole('button', { name: /add cool gadget to cart/i });
        fireEvent.click(button);

        // UI swapped to Quantity (button disappears)
        expect(screen.queryByRole('button', { name: /add cool gadget to cart/i })).not.toBeInTheDocument();

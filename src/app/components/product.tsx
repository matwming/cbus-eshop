...
export const ProductCard = ({ product }: Props) => {
    return (
            ...
            >
                <div className="pointer-events-none absolute inset-0 opacity-0 blur-2xl transition-opacity group-hover:opacity-60"
                     style={{ background: 'radial-gradient(600px circle at var(--x,50%) var(--y,50%), rgba(59,130,246,0.15), transparent 40%)' }} />
          ...
          {product.category}
                ...
                <div className="mt-4 space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                        <p className="text-lg font-bold tabular-nums text-zinc-900 dark:text-zinc-100" data-testid="product-price">
